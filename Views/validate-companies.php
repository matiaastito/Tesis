        ...
        <div class="container">
            <div class="tabla">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                    <?php
                    foreach ($companyList as $company) { if($company->getActive() == "no"){
                    ?>
                    <tr>
                    <th scope="row"></th>
                    ...
                    <form action="<?php echo FRONT_ROOT . "/Company/Validar" ?>" method="post">
                            <td><input type="hidden" name="CUIL" id="CUIL" value="<?php echo $company->getCUIL();?>">
                            <button class="btn btn-outline-light3" type="submit" name="">Validar</button></td>
