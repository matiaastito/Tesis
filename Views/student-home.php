    ...
    <div class="container">
      ...
      <nav class="mb-5">
        <ul class="nav justify-content-center">
          <li class="nav-item">
            <a href="<?php echo FRONT_ROOT . "/JobOffer/ShowListApplyView"?>" class="nav-link text-white">
              <svg class="bi d-block mx-auto mb-1" width="24" height="24">
                <use xlink:href="#people-circle" />
              </svg>
              Ver/Aplicar oferta laboral
            </a>
          </li>
          <li class="nav-item">
      ...
      <section>
        <form action="">
          <div class="mb-3">
            ...
            <textarea class="caja_de_texto" id="exampleFormControlTextarea1" rows="3"></textarea>
          </div>
