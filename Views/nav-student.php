    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?php echo  FRONT_ROOT . "/JobApplication/ShowListView" ?>">Mis Propuestas</a>
          </li>
          ...
          <li class="nav-item active">
            <a href="<?php echo  FRONT_ROOT . "/Home/ShowStudentView" ?>" class="nav-link active">Mi Cuenta</a>
          </li>
          <li class="nav-item active">
